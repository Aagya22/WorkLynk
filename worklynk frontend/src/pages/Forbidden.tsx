  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden select-none">
      ...
      <div className="max-w-md w-full text-center z-10 space-y-6">
        <div className="p-5 bg-red-950/30 border border-red-500/20 rounded-full w-20 h-20 flex items-center justify-center mx-auto shadow-2xl shadow-red-500/5 animate-bounce">
        ...
        <div className="space-y-2">
          <h2 className="text-4xl font-extrabold text-slate-100 tracking-tight">403 Forbidden</h2>
          <p className="text-sm font-semibold uppercase tracking-wider text-red-400">Access Denied</p>
        </div>
